...
a 2{,}600-word, 3{,}500-document corpus the two cross near $K=200$: \pkg{tomotopy}
is about $2\times$ faster at $K=20$, the gap closes through $K=100$, and
\pkg{topica} is faster beyond, by about $1.5\times$ at $K=400$, where its time has
barely grown while \pkg{tomotopy}'s has risen with $K$. The fine-grained models
